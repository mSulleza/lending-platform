...
export default function Login() {
  ...
  if (session) {
    return (
      <div className="flex justify-center items-center min-h-[70vh]">
        <Card className="max-w-md w-full shadow-lg rounded-xl p-2 bg-gradient-to-r from-background to-background/80 backdrop-blur-sm border border-foreground/10">
        ...
        <CardBody className="flex flex-col gap-6 p-6">
          ...
          <div className="flex justify-center py-5 w-full">
            <Button
              ...
              variant="bordered"
              className="w-full relative overflow-visible flex items-center justify-center gap-2 py-6 group"
              startContent={
                <svg
                  viewBox="0 0 24 24"
                  width="24"
